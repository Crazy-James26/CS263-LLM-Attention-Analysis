...
def main():
    ...
    model_path = './ckpts/best_bigbird_summarization_model.pt'
    ...
    visualize_correlation(correlations, importance_scores, tokens, './ckpts/bigbird_summarization_correlations.png')
